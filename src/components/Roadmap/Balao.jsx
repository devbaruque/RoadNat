    ...
    <div className="relative flex flex-col items-center">
      ...
      {!isLast && (
        <div className="relative z-0 flex flex-col items-center">
          {/* Linha principal */}
          <div className="w-1 h-16 bg-gradient-to-b from-gray-300 to-gray-400 rounded-full mt-4 mb-4 shadow-sm" />
          
          {/* Seta */}
          <div className="relative">
            <div className="w-0 h-0 border-l-[8px] border-r-[8px] border-t-[12px] border-l-transparent border-r-transparent border-t-gray-400 mb-2" />
